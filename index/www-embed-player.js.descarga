...
function Ld(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g="NT"==f,h=parseInt(b.freshLifetimeSecs||"",10),k=parseInt(b.validLifetimeSecs||"",10),m=b["1p_jar"]||"";b=b.pucrd||"";Id();1==e?M.La():M.Ka();if(!f&&M.shouldRetry())Fd(".google.com")&&(L[1]=".google.com"),M.ga();else{var u=Gd.googleToken=Gd.googleToken||{},Z=0==e&&f&&r(f)&&!g&&pa(h)&&0<h&&pa(k)&&0<k&&r(m);g=g&&!M.ca()&&(!(K[3]>=z())||"NT"==K[1]);var Aa=!(K[3]>=
z())&&0!=e;if(Z||g||Aa)g=z(),h=g+1E3*h,k=g+1E3*k,1E-5>Math.random()&&(g="https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e,p.google_image_requests||(p.google_image_requests=[]),Aa=p.document.createElement("img"),Aa.src=g,p.google_image_requests.push(Aa)),u[5]=e,u[1]=f,u[2]=h,u[3]=k,u[4]=m,u[6]=b,Id();if(Z||!M.ca()){e=M.ka();for(f=0;f<e.length;f++)M.ia(e[f]);e.length=0}}};
Kd(a)}
